                    ...
                    <form action="{{ route('category.update', ['category' => $category->id]) }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" placeholder="Enter Category name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" value="{{ $category->slug }}"
                                    placeholder="Enter category slug" name="slug" id="slug"
                                    data-action="{{ route('category.slug') }}" data-id="{{ $category->id }}"
                                    content="{{ csrf_token() }}">
                        ...
                        <div class="card-footer">
                            <button id="submit" data-action="{{ route('category.edit', ['category' => $category->id]) }}"
                                class="btn btn-primary category-update">category-update</button>
                        </div>
                    </form>
                </div>
            </div>
...
@endsection
@section('links')
    {!! JsValidator::formRequest('App\Http\Requests\UpdateCategoryRequest', '#category-update') !!}
